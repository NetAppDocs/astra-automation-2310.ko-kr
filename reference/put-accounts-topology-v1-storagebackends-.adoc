...
* 구성 버전을 지정하면 스토리지 백엔드 유형별 구성 변경 사항이 적용되며, 여기에는 스토리지 백엔드의 초기 설치가 포함될 수 있습니다.
* 구성 버전을 지정하면 storageClass 리소스가 추가, 수정 또는 제거될 수 있습니다.
...
| protectionStateUnready | 배열[string] | 거짓  a| 
